...
namespace BanVeMayBay.Controllers
{
    public class SiteController : Controller
    {
        ...
        public ActionResult flightSearch(FormCollection fc, int? page)
        {
            ...
            ViewBag.urlsearch = "flight-search";
            ...
            if (typeTicket.Equals("enable"))
            {
                ...
                {
                    Message.set_flash("Ngày về phải sau hoặc bằng ngày đi!", "danger");
        ...
        public ActionResult AllChuyenBay(int? page)
        {
            ...
            int pageNumber = (page ?? 1);
            var list_flight = db.tickets.Where(m => m.status == 1 && m.departure_date >= datenow).ToList();
